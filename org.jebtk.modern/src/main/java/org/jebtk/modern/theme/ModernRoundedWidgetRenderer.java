...
public class ModernRoundedWidgetRenderer extends ModernWidgetRenderer {
  ...
  public void buttonFillPaint(Graphics2D g2,
    ...
    case SELECTED:
      /*
       * paint = new GradientPaint(0, y, HIGHLIGHTED_FILL_COLOR, 0, y + h,
       * SELECTED_FILL_COLOR);
       * 
       * g2.setPaint(paint);
       */
   ...
   * 
   * @see
   * org.abh.common.ui.theme.ModernWidgetRenderer#drawDialogButtonFill(java.awt.
   ...
   * 
   * @see
   * org.abh.common.ui.theme.ModernWidgetRenderer#drawRibbonButtonSelectedFill(
   * java.awt.Graphics2D, int, int, int, int)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.abh.common.ui.theme.ModernWidgetRenderer#fill(java.awt.Graphics2D,
   * int, int, int, int)
   */
  @Override
   ...
   * 
   * @see
   * org.abh.common.ui.theme.ModernWidgetRenderer#outline(java.awt.Graphics2D,
   * int, int, int, int)
   */
  @Override
