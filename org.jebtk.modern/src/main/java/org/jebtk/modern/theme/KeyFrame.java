...
public class KeyFrame extends AbstractStyleProperties {
  ...
  /**
   * Returns the most uptodate property value. If a custom property was
   * added, return that, else work backwards through the style list until
   * a style containing the property of interest is found. Styles are added
   * in order so the last style added is considered the latest.
   * 
   * @param name
   * @return
   */
