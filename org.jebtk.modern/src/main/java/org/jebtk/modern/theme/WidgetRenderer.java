...
public abstract class WidgetRenderer {
	...
	/**
	 * Should set the paint or color used to fill a selected button or 
	 * object.
	 *
	 * @param g2 the g 2
	 * @param x the x
	 ...
	 * @param h the h
	 */
	public abstract void drawOutline(Graphics2D g2, 
			int x, 
			int y, 
			int w, 
			int h);
	 ...
	 * @param h the h
	 */
	public abstract void outline(Graphics2D g2, 
			int x, 
			int y, 
			int w, 
			int h);
	 ...
	 * @param w the w
	 */
	public void drawCollapseBar(Graphics2D g2, String name, 
			boolean expanded, 
			int w) {
	 ...
	 * @param rect the rect
	 */
	public void drawDialogFill(Graphics2D g2, 
			IntRect rect) {
	 ...
	 * @param h the h
	 */
	public void drawPillButtonFill(Graphics2D g2, 
			int x, 
			int y, 
			int w, 
			int h) {
	 ...
	 * @param h the h
	 */
	public void drawPillButtonOutline(Graphics2D g2, 
			int x, 
			int y, 
			int w, 
			int h) {
