...
public class ModernWidgetRenderer extends WidgetRenderer {
	...
	public static final Color HIGHLIGHTED_FILL_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(10);
	...
	public static final Color HIGHLIGHTED_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(14);

	/** The Constant SELECTED_OUTLINE_COLOR. */
	public static final Color SELECTED_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(16);

	/** The Constant DISABLED_OUTLINE_COLOR. */
	public static final Color DISABLED_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getHighlight32(8);


	/** The Constant PRIMARY_DIALOG_BUTTON_OUTLINE_COLOR. */
	public static final Color PRIMARY_DIALOG_BUTTON_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(22);

	/** The Constant FOCUSED_PRIMARY_DIALOG_BUTTON_OUTLINE_COLOR. */
	public static final Color FOCUSED_PRIMARY_DIALOG_BUTTON_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(30);
	...
	private static final Color DIALOG_CONTENT_COLOR = 
			ThemeService.getInstance().colors().getHighlight32(1);

	/** The Constant DIALOG_BUTTON_FILL_COLOR. */
	public static final Color DIALOG_BUTTON_FILL_COLOR =
			ThemeService.getInstance().colors().getHighlight32(1);
	...
	public static final Color FOCUSED_DIALOG_BUTTON_OUTLINE_COLOR =
			ThemeService.getInstance().colors().getHighlight32(14);

	public static final Color RIBBON_BACKGROUND =
			ThemeService.getInstance().colors().getColorHighlight32(24);
	
	public static final Color RIBBON_SELECTED_COLOR = 
			ThemeService.getInstance().colors().getHighlight32(31);
	
	/** The Constant RIBBON_SELECTED_FILL_COLOR. */
	public static final Color RIBBON_SELECTED_FILL_COLOR =
			ColorUtils.getTransparentColor80(RIBBON_SELECTED_COLOR); 
	
	/** The Constant RIBBON_SELECTED_HIGHLIGHT_COLOR. */
	public static final Color RIBBON_HIGHLIGHT_FILL_COLOR = 
			ColorUtils.getTransparentColor85(RIBBON_SELECTED_COLOR); //RIBBON_SELECTED_FILL_COLOR;

	//ThemeService.getInstance().colors().getHighlight32(6);

	/** The Constant RIBBON_HIGHLIGHTED_OUTLINE_COLOR. */
	public static final Color RIBBON_HIGHLIGHTED_OUTLINE_COLOR =
			RIBBON_SELECTED_FILL_COLOR; //ThemeService.getInstance().colors().getHighlight32(6);

	/** The Constant RIBBON_SELECTED_OUTLINE_COLOR. */
	public static final Color RIBBON_SELECTED_OUTLINE_COLOR =
			ColorUtils.getTransparentColor75(RIBBON_SELECTED_COLOR); //ThemeService.getInstance().colors().getHighlight32(8);

	/** The Constant RADIO_COLOR. */
	public static final Color RADIO_COLOR =
			ThemeService.getInstance().colors().getColorHighlight32(14);

	/** The Constant COLLAPSE_FILL_COLOR_1. */
	public static final Color COLLAPSE_FILL_COLOR_1 = 
			ThemeService.getInstance().colors().getHighlight32(1);

	/** The Constant COLLAPSE_FILL_COLOR_2. */
	public static final Color COLLAPSE_FILL_COLOR_2 = 
			ThemeService.getInstance().colors().getHighlight32(4);

	/** The Constant PILL_BUTTON_HIGHLIGHT_FILL. */
	private static final Color PILL_BUTTON_HIGHLIGHT_FILL = 
			ThemeService.getInstance().colors().getHighlight32(2);
	
	/** The Constant PILL_BUTTON_SELECTED_FILL. */
	private static final Color PILL_BUTTON_SELECTED_FILL = 
			ThemeService.getInstance().colors().getHighlight32(4);

	/** The Constant PILL_BUTTON_OUTLINE. */
	private static final Color PILL_BUTTON_OUTLINE = 
			ThemeService.getInstance().colors().getHighlight32(8);
	 ...
	 * The constant SCALE.
	 */
	public static final double CHECK_SCALE =
			SettingsService.getInstance().getAsDouble("theme.icons.check-icon.width-scale");

	/**
	 * The constant TICK_SCALE.
	 */
	public static final double TICK_SCALE =
			SettingsService.getInstance().getAsDouble("theme.icons.check-icon.tick-scale");

	/** Defines the size of the radio button relative to the rendering space. */
	public static final double RADIO_SCALE =
			SettingsService.getInstance().getAsDouble("theme.icons.radio-icon.scale");
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawButtonOutline(java.awt.Graphics2D, int, int, int, int, org.abh.common.ui.theme.RenderMode, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#buttonHighlightedOutlinePaint(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	public void buttonOutlinePaint(Graphics2D g2, 
		...
		if (mode == RenderMode.SELECTED) {
			...
			g2.setColor(HIGHLIGHTED_OUTLINE_COLOR);
		}
		 */
	}

	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#buttonHighlightedFillPaint(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#primaryDialogButtonFillPaint(java.awt.Graphics2D, int, int, int, int, org.abh.common.ui.theme.RenderMode, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawPrimaryDialogButtonOutline(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawDialogButtonFill(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawDialogButtonOutline(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawRibbonButtonFill(java.awt.Graphics2D, int, int, int, int, org.abh.common.ui.theme.RenderMode, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawRibbonButtonSelectedFill(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawChecked(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawRadio(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	public void drawRadio(Graphics2D g2,
			int x, 
			int y, 
			int w, 
			int h) {
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawRadioSelected(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	public void drawRadioSelected(Graphics2D g2,
			int x, 
			int y, 
			int w, 
			int h) {
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawDialogFill(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawDialogContentBox(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawCollapseBar(java.awt.Graphics2D, java.lang.String, boolean, int, int, int, int)
	 */
	@Override
	public void drawCollapseBar(Graphics2D g2,
		...
		/*
		GradientPaint gradColor = new GradientPaint(0,
				0, 
				COLLAPSE_FILL_COLOR_1, 
				0, 
				h,
				COLLAPSE_FILL_COLOR_2);
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawPillButton(java.awt.Graphics2D, int, int, int, int, org.abh.common.ui.theme.RenderMode, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawOutline(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawContentBoxFill(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawContentBoxOutline(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#drawBackground(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#fill(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.abh.common.ui.theme.WidgetRenderer#outline(java.awt.Graphics2D, int, int, int, int)
	 */
	@Override
