...
public class ModernDialogMultiCardWindow extends ModernDialogHelpWindow {
	 ...
	 * @param help the help
	 */
	public ModernDialogMultiCardWindow(ModernWindow parent, 
			String title,
			String help) {
	...
	private final void createUi(ModernDialogTaskType type) {
		...
		//if (mHelpButton != null) {
		//	leftPanel.setFooter(new ModernComponent(mHelpButton, ModernWidget.DOUBLE_PADDING));
		//}
		...
		ModernComponent tabsPanel = 
				new ModernComponent(new CardPanel(new ModernComponent(mViewPanel, ModernWidget.QUAD_BORDER)), ModernWidget.DOUBLE_BORDER);
