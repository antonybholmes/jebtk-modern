...
public class PrimaryDialogButtonAnimation extends ButtonHighlightAnimation {
  public static final Color OUTLINE_COLOR_1 = ThemeService.getInstance().colors().getColorHighlight32(24);

  public static final Color OUTLINE_COLOR_2 = ThemeService.getInstance().colors().getColorHighlight32(28);

  public static final Color FILL_1 = ThemeService.getInstance().colors().getColorHighlight32(20);

  public static final Color FILL_2 = ThemeService.getInstance().colors().getColorHighlight32(24);
