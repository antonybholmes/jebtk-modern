...
public class ModernComponentAspectRatioSquare extends ModernComponentAspectRatio {
  @Override
  public Dimension getPreferredSize(Dimension preferred,
      Dimension min,
      Dimension max) {
  ...
  @Override
  public Dimension getMinimumSize(Dimension preferred,
      Dimension min,
      Dimension max) {
  ...
  @Override
  public Dimension getMaximumSize(Dimension preferred,
      Dimension min,
      Dimension max) {
    return getPreferredSize(preferred, min, max);
  }
