...
public class CheckSwitchAnimation extends WidgetAnimation {
	...
	public void draw(ModernWidget widget, Graphics2D g2, Object... params) {
		...
		g2.fillRoundRect(widget.getInsets().left + ModernCheckSwitch.SWITCH_ICON_OFFSET, 
				y2, 
				ModernCheckSwitch.SLIDER_WIDTH - 2 * ModernCheckSwitch.SWITCH_ICON_OFFSET, 
				HEIGHT, 
				HEIGHT, 
				HEIGHT);
		...
		g2.setColor(ModernWidget.LINE_COLOR);
		g2.drawRoundRect(ModernCheckSwitch.SLIDER_OFFSET, 
				y2, 
				ModernCheckSwitch.SLIDER_WIDTH - 1, 
				HEIGHT - 1, 
				HEIGHT, 
				HEIGHT);
		*/
