...
public class PillButtonOutlineAnimation extends ButtonOutlineAnimation {
  public PillButtonOutlineAnimation(ModernWidget button) {
    super(button);
  }
  ...
  public void outline(Graphics2D g2,
    ...
    DrawUIService.getInstance().getRenderer("pill-outline").draw(g2, c, x, y, w, h, getFadeColor("outline"));
